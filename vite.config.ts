...
export default defineConfig({
  // Only the GitHub Pages deploy workflow sets PAGES_BASE (see
  // .github/workflows/deploy.yml) — a project site is served from
  // /<repo>/, not /. Local dev/build/preview are all unaffected and keep
  // using the root path they always have.
